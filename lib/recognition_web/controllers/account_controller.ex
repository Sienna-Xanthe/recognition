defmodule RecognitionWeb.AccountController do
  use RecognitionWeb, :controller

  alias Recognition.Accounts
  alias Recognition.Accounts.Account
  alias RecognitionWeb.Auth.{Guardian, ErrorResponse}

  plug :is_authorized_account when action in [:update, :delete]
  action_fallback RecognitionWeb.FallbackController
